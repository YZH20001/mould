...
class Home extends React.Component {
    ...
    render() {
        ...
        function toggle() {
            ...
            if (this.state.display_name == 'inline-block') {
                this.setState({
                    display_name: 'none',
                })
            }
            else if (this.state.display_name == 'none') {
                this.setState({
        ...
        return (<Layout style={{ height: '100%' }}>
            <Sider trigger={null} collapsible collapsed={collapsed} onCollapse={(collapsed, type) => {
                ...
                // console.log(type);
            }} breakpoint="lg" style={{ background: '#001529' }}>
                <div className={styles.logo}>
                    <img src={Logo}></img>
                    <h1 style={{display:this.state.display_name} }>管理系统</h1>
                </div>
            ...
            <Layout>
                ...
                <Footer className={styles.contentF}>GAIA ©2019 Created by 浅语科技有限公司</Footer>
            </Layout>
...
Home = connect((state) => {
    return Object.assign({}, state.home, {
        thirdPartyVisible: state.indexpage.setting.alipayIsEnabled ||
